...
//    assign led2N4 = {{clk_out}, {6'b000000}, {Branch, nBranch, Zero, Jrn, Jal, Jmp, rst}, {PC_plus_4_out[4:0]}, {PC[4:0]}};
    ...
    leds leds_u (clk_out, rst, ledctrl, ledctrl, Led_address, Led_write_data, Led_out);
    ...
    switchs switchs_u (clk_out, rst, switchctrl, switchctrl, Switch_address, Switch_read_data, Switch_in);
endmodule
